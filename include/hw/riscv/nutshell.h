...
typedef uint64_t (*get_cpt_limit_instructions_func)(NUTSHELLState *ns);
typedef uint64_t (*get_sync_limit_instructions_func)(NUTSHELLState *ns, int cpu_idx);
typedef void (*try_take_cpt_func)(NUTSHELLState* ns, uint64_t icount, int cpu_idx, bool exit_sync_period);
typedef void (*after_take_cpt_func)(NUTSHELLState *ns, int cpu_idx);
typedef void (*try_set_mie_func)(void *env, NUTSHELLState *ns);
typedef void (*update_cpt_limit_instructions_func)(NUTSHELLState *ns, uint64_t icount);
typedef void (*update_last_seen_instructions_func)(NUTSHELLState *ns, int cpu_idx, uint64_t profiling_insns);
typedef void (*update_sync_limit_instructions_func)(NUTSHELLState *ns);
...
struct NUTSHELLState{
    ...
    /*< public >*/
    RISCVHartArrayState soc[NUTSHELL_CPUS_MAX];
    ...
    DeviceState *irqchip[NUTSHELL_CPUS_MAX];
};
